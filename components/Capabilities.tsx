...
export const Capabilities: React.FC<CapabilitiesProps> = ({ mode, lang }) => {
  ...
  const seoIntro = isEn
    ? [
        'Capability matrix: systems architecture, AI infrastructure, OSINT fusion, industrial operations.',
        'Mapped to outputs: control, evidence, performance, resilience.',
        'Designed for rapid technical + strategic assessment.'
      ]
    : [
        'Matice schopností: systémová architektura, AI infrastruktura, OSINT fúze, průmyslové operace.',
        'Schopnosti mapuji na výstupy: kontrola, audit trail, výkon, robustnost.',
        'Použijte pro rychlé posouzení technické i strategické připravenosti.'
      ];
  ...
  return (
    <div className="max-w-7xl mx-auto pb-40 animate-in fade-in duration-1000 px-4 md:px-0">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div className="md:col-span-8 group relative border border-white/10 bg-[#081023]/95 backdrop-blur-xl p-6 sm:p-8 md:p-12 industrial-clip overflow-hidden transition-all duration-500 hover:border-white/30 card-hover">
        ...
        <div className="md:col-span-4 group relative border border-white/10 bg-[#081023]/95 backdrop-blur-md p-6 sm:p-8 industrial-clip hover:border-white/30 transition-colors card-hover">
        ...
        <div className="md:col-span-5 group relative border border-white/10 bg-[#081023]/95 backdrop-blur-md p-6 sm:p-8 industrial-clip hover:border-white/30 transition-colors card-hover">
        ...
        <div className="md:col-span-7 group relative border border-white/10 bg-[#081023]/95 p-6 sm:p-8 industrial-clip hover:border-white/30 transition-all overflow-hidden card-hover">
      ...
      <div className="mt-24 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        <div className="p-6 border border-white/5 bg-[#081023]/95 industrial-clip text-center flex flex-col items-center justify-center gap-2 card-hover-soft">
        ...
        <div className="p-6 border border-white/5 bg-[#081023]/95 industrial-clip text-center flex flex-col items-center justify-center gap-2 hidden md:flex card-hover-soft">
