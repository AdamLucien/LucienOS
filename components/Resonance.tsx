    ...
    <div className="max-w-7xl mx-auto pb-40 animate-in fade-in duration-1000 px-4 md:px-0">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
        ...
        <div className="md:col-span-8 space-y-8">
          <div className="border border-white/10 bg-[#0a1931]/95 backdrop-blur-xl p-6 md:p-10 industrial-clip relative group overflow-hidden transition-all duration-700 hover:border-white/30 hover:shadow-[0_0_40px_rgba(255,255,255,0.06)]">
            ...
            <div className="flex flex-col gap-10">
              ...
              <div className="w-full space-y-6">
                ...
                <div className="max-w-3xl mx-auto">
                  <div className="relative border border-white/10 bg-[#0a1931]/95 industrial-clip p-4 shadow-2xl transition-all duration-700 hover:border-white/30 hover:shadow-[0_0_35px_rgba(90,118,150,0.24)]">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-6">
                      {data.categories[1].videos.map((video, idx) => {
                        ...
                        return (
                          <div key={video.id} className="relative border border-white/10 bg-[#0a1931]/95 industrial-clip p-2 transition-all duration-500 hover:border-white/30 hover:-translate-y-0.5 hover:shadow-[0_0_20px_rgba(255,255,255,0.08)]">
                            <div className="absolute top-2 left-2 text-[7px] font-mono opacity-50 uppercase tracking-widest">
                              {video.label}
                            </div>
                            <div className="absolute top-2 right-2 text-[7px] font-mono opacity-50 uppercase tracking-widest">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
             <div className="border border-white/10 bg-[#0a1931]/95 p-8 industrial-clip relative group overflow-hidden transition-all duration-700 hover:border-white/30 hover:shadow-[0_0_30px_rgba(255,255,255,0.06)]">
             ...
             <div className="border border-white/10 bg-[#0a1931]/95 p-8 industrial-clip relative group transition-all duration-700 hover:border-white/30 hover:shadow-[0_0_30px_rgba(255,255,255,0.06)]">
               <div className="absolute top-0 left-0 w-4 h-full" style={{ backgroundColor: primaryColor }} />
        ...
        <div className="md:col-span-4 space-y-8">
          <div className="border border-white/10 bg-[#0a1931]/95 p-8 industrial-clip relative card-hover">
          ...
          <div className="p-10 border-2 border-dashed border-white/10 bg-[#0a1931]/95 text-center relative overflow-hidden group card-hover-soft">
